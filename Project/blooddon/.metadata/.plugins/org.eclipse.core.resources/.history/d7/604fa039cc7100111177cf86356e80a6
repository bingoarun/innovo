...
String q="select * from arun.mail left join arun.bloodbank on bloodbank.bank_id=mail.to_id where arun.mail.delete=1 and arun.mail.to_id=(select bank_id from arun.bloodbank where name='"+uname+"')";
...
<body>
<span class="tabletitle">Trash:</span><br>
