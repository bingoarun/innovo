...
String q="insert into arun.mail (from_id,to_id,subject,message,read,delete) values ((select bank_id from arun.bloodbank where name='"+uname+"'), "+to_id+",'"+subject+"','"+message+"','"+0+"','"+0+"')";
