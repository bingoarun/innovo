...
else
{
	...
	{
		d_id=rs.getString("donor_id");
	}
	String str="insert into arun.feedback (donor_id,feed_back,flag,bank_id,delete,donation_date)  values("+d_id+",'"+feedback+"',"+1+",'"+bank_id+"',"+0+",'"+ date1+"')";
