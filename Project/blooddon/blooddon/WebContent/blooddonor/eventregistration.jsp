...
<p class="pagemenu"><span class="tableelements"><span class="pagemenu"><span class="successmsg">Successfully registered for event !!! </span></span></span>
</p>
<p class="pagemenu"><a href="welcome.jsp">Go to home</a></p>
</body>
</html>