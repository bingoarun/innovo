...
String str="insert into arun.bloodbank (name,mail_id,phnum,landline_num,area,pincode,manager_name,login_status,password,names,status)  values('"+name+"','"+mail_id+"','"+phnum+"','"+landline_num+"','"+address+"','"+ pincode+"','"+manager_name+"',"+0+",'"+password+"','"+names+"',"+1+")";
...
<body class="successmsg">
 Blood bank details submitted to Administrator for approval.
</body>
</html>