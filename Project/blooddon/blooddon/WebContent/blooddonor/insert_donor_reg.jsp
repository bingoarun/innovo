...
String date1=new String(datum1);
//date conversion

date1=datum1.substring(6,10)+"-"+datum1.charAt(3)+datum1.charAt(4)+"-"+datum1.charAt(0)+datum1.charAt(1);
...
String str="insert into arun.blooddonor (fname,lname,username,password,blood_grp,dob,prev_bld_date,mail_id,ph_num,login_status,office_phnum,address,pincode,availability,delete)  values('"+fname+"','"+lname+"','"+name+"','"+password+"','"+bld_grp+"','"+ date1+"','"+date2+"','"+mail_id+"','"+phnum+"','"+"1"+"','"+ophnum+"','"+street+"','"+pincode+"','1',"+"0)";
...
<link href="successmsg.css" rel="stylesheet" type="text/css">
</head>
