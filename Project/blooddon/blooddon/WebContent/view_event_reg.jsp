...
String q="select * from arun.event where delete=0 and bdc_event=1 and bank_id=(select bank_id from bloodbank where   name='"+ uname +"' and days(current date)-days(end_date) >=0)";
...
<form name="form1" method="post" action="view_event_reg_table.jsp" onSubmit="return validate()">
