...
<td><form id ="deletefeed" name="deletefeed" method="post" action="deletefeed.jsp"><input type="hidden" name="fb_id" id="fb_id" value="<%= rs.getString("fb_id") %>"><input type ="submit" value="Delete"></form></td>
