...
if(event_name=="")
	...
	{
	window.alert("Enter the ending date");
	}
else if (description=="")
	{
...
<form name="form1" id ="form1" action="insert_org_event.jsp" method="post" onsubmit="return validate()">
  ...
  <td width="159">
  <tr>
    <td width="207" align="right">Event name:</td>
    <td width="233"><label>
  ...
  <tr>
    ...
    <td width="287"><input name="datum1" type="text" readonly="readonly">
      <a href="#" onClick="setYears(1947, 2008);
       showCalender(this, 'datum1');"> <img src="calender.png"></a>
      <table id="calenderTable">
        <tbody id="calenderTableHead">
          <tr>
            <td colspan="4" align="center"><select name="selectMonth" id="selectMonth" onChange="showCalenderBody(createCalender(document.getElementById('selectYear').value,
            ...
            <td colspan="2" align="center"><select name="selectYear" id="selectYear" onChange="showCalenderBody(createCalender(this.value, 
  ...
  <tr>
    ...
    <td><input name="datum2" type="text" readonly="readonly">
      <a href="#" onClick="setYears(1947, 2008);
       showCalender(this, 'datum2');"> <img src="calender.png"></a>
      <!-- Calender Script  -->
      <table id="calenderTable">
        <tbody id="calenderTableHead">
          <tr>
