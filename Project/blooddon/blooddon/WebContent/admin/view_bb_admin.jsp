...
<td><form id ="deletebank" name="deletebank" method="post" action="deletebank.jsp"><input type="hidden" name="bank_id" id="bank_id" value="<%= rs.getString("bank_id") %>"><input type ="submit" value="Delete"></form></td>
</tr>
<%
}
