...
java.sql.ResultSet rs=st.executeQuery("select * from arun.administrator where username like '"+uname+"'and password like '"+pass+"'");
...
document.location="loginadmin.jsp";//redirect to home page decider
</script>
<%
}
...
%>
<script language="JavaScript">
window.alert("Invalid Username and password. Redirecting to login page.In createsession.jsp");
