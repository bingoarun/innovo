...
st.executeUpdate("update arun.administrator set login_status=0 where username like '"+ses.getValue("uname")+"'");
...
document.location="loginfrm.jsp";
}
</script>
</body>
</html>
...
document.location="admin_index.jsp";
</script>
<%
}
%>