...
java.sql.ResultSet rs=st.executeQuery("select manager_name from arun.bloodbank where status=0 and name like '"+uname+"'and password like '"+pass+"'");
...
document.location="loginbank.jsp";//redirect to home page decider
</script>
<%
}
