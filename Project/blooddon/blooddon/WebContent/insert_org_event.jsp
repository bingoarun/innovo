...
String q="insert into arun.event (bank_id,description,str_date,end_date,str_time,end_time,pgm_name,event_status,delete,venue,bdc_event) values ((select bank_id from arun.bloodbank where name='"+uname+"'),' "+description+"','"+date1+"','"+date2+"','"+0+"','"+0+"','"+pgm_name+"','"+1+"',"+0+",'"+venue+"',"+1+")";
